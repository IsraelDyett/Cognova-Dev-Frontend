				...
				<div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
					<div className="flex">
						<div className="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
							<span className="font-semibold text-indigo-600">Announcement</span>
					...
					<p className="mt-6 text-lg leading-8 text-gray-600">
						{siteConfig.applicationName} is an advanced AI-powered customer support
						platform that uses natural language processing and machine learning to
						provide 24/7 automated support across multiple channels, including WhatsApp
						and web chat.
					</p>
