...
export const ProAlert: React.FC<{ title: string; description: string }> = ({
  title,
  description,
}) => (
...
export const TextInput: React.FC<DialogProps> = ({ setIsLoading, isLoading }) => (
  <div className="space-y-4">
    ...
    <p className="text-muted-foreground">Paste or type text directly to train your bot.</p>
...
export const PDFUpload: React.FC<DialogProps> = ({ setIsLoading, isLoading }) => (
  <div className="space-y-4">
    ...
    <p className="text-muted-foreground">Upload PDF files to train your bot with their content.</p>
...
export const TxtUpload: React.FC<DialogProps> = ({ setIsLoading, isLoading }) => (
  <div className="space-y-4">
    ...
    <p className="text-muted-foreground">Upload plain text files to train your bot.</p>
