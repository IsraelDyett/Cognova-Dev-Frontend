  ...
  return (
    <div>
      <div>
        ...
        <p className="text-muted-foreground mb-8">Configure which bots can access each source</p>
      </div>
            ...
            <TableBody>
              {sources.map((source) => (
                <TableRow key={source.id}>
                  ...
                  <TableCell>{source.bots.map((bs) => bs.bot.name).join(", ") || "None"}</TableCell>
                      ...
                      <DialogContent>
                        ...
                        <div className="space-y-4">
                          {workspaceBots.map((bot) => {
                            const isAssociated = source.bots.some((bs) => bs.bot.id === bot.id);
                            return (
