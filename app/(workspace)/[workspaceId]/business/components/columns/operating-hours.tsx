...
>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return <span className="font-medium">{daysOfWeek[parseInt(row.getValue("dayOfWeek"))]}</span>;
    },
  },
  {
    accessorKey: "hours",
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-48 rounded-lg" side="right" align="start">
            ...
            <DropdownMenuItem onClick={() => alert("Edit " + daysOfWeek[hours.dayOfWeek])}>
              <Pencil className="text-muted-foreground" />
              <span>Edit</span>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => alert("Delete " + daysOfWeek[hours.dayOfWeek])}>
