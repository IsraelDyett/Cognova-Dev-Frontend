...
export function HourForm({ wrapInDialog = true }: { wrapInDialog?: boolean }) {
	...
	return (
		<DialogForm
			...
			title={`${initialCrudFormData ? "Edit" : "Create"} Hour`}
			description={`${initialCrudFormData ? "Make changes to the" : "Add a new"} hour.`}
		>
			{formContent}
		</DialogForm>
	);
