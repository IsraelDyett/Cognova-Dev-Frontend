...
export function BotForm() {
  const { createBot, updateBot, onCloseCrudForm, initialCrudFormData, isOpenCrudForm } = useBotStore();
  ...
  return (
    <Dialog open={isOpenCrudForm} onOpenChange={onCloseCrudForm}>
      <DialogContent size={"3xl"}>
        <DialogHeader>
          <DialogTitle>
            {initialCrudFormData ? 'Edit' : 'Create'} Bot
          </DialogTitle>
          <DialogDescription>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:grid-cols-4">
