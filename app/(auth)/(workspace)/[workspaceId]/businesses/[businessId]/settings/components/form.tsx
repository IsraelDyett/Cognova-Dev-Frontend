                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <div className="relative">
                                        ...
                                        <Input type="number" step="0.01" className="pl-8" {...field} value={field.value || ''} onChange={e => field.onChange(e.target.valueAsNumber)} />
                                    </div>
                                </FormControl>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>Estimated time for delivery arrival.</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>The minimum amount required for an order.</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <div className="relative">
                                        ...
                                        <Input type="number" className="pl-8" {...field} value={field.value || ''} onChange={e => field.onChange(e.target.valueAsNumber)} />
                                    </div>
                                </FormControl>
                                <FormDescription>The number of days allowed for returns.</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>The number of days the warranty is valid for.</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>The currency used for transactions.</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
