...
export async function deleteBusinessLocation(id: string): Promise<ApiResponse<BusinessLocation>> {
...
export async function retrieveBusinessLocation(id: string): Promise<ApiResponse<BusinessLocation>> {
