  ...
  return (
    <section>
      <div className="text-center mb-16">
        <h2 className="text-base font-semibold leading-7 text-primary pb-4">How It Works</h2>
        ...
        <div className="space-y-16">
          <div className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-base">
                Upload your business documents (PDFs, website URLs, product catalogs) to our secure
                platform. Our AI will learn everything about your products, services, and business
                processes.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-base">
                Connect your WhatsApp Business account and embed our smart chatbot on your website.
                Your AI assistant is now ready to handle customer inquiries 24/7 across all
                channels.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-base">
                Access your dashboard to monitor conversations, analyze performance, and fine-tune
                your AI. Watch as your AI handles product inquiries, support questions, and customer
